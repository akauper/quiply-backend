...
from .analysis_engine import PitchToInvestorsAnalysisEngine
from .agent_builder import PitchToInvestorsAgentBuilder
from .conversation_controller import PitchToInvestorsConversationController
from .stage_manager import PitchToInvestorsStageManager


class PitchToInvestors(Scenario):
    ...
    def create_conversation_controller(self) -> PitchToInvestorsConversationController:
        return PitchToInvestorsConversationController(scenario=self)

    def create_agent_builder(self) -> PitchToInvestorsAgentBuilder:
        return PitchToInvestorsAgentBuilder(scenario=self)

    def create_analysis_engine(self) -> PitchToInvestorsAnalysisEngine:
        return PitchToInvestorsAnalysisEngine(scenario=self)

    def create_stage_manager(self) -> PitchToInvestorsStageManager:
        return PitchToInvestorsStageManager(scenario=self)
    ...
    def _format_scenario_description(self) -> str:
        ...
        prompt = prompts.pitch_to_investors.scenario_description
