...
class SpeedDatingStageData(ScenarioStageData):
    pass


class SpeedDatingStage(ScenarioStage[SpeedDatingStageData]):
    pass


class SpeedDatingSkillsAnalysis(ScenarioSpecificAnalysis):
