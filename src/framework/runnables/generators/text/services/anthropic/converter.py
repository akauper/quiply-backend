...
from src.framework import Message, MessageRole, TokenUsage, TextResponseChunk, TextChoiceChunk
    ...
    def to_completion_create_params(
        ...
        try:
            ...
            if isinstance(request, list):
                ...
                if len(request) == 0:
                    loggers.framework.warning("Anthropic Request messages is empty. This is not allowed. Adding a message with 'Start the conversation' content.")
