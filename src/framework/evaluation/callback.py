...
from .models.events import AgentStepEvent, AgentInputEvent, AgentResponseEvent, BaseStepEvent, TextGenStepEvent, TextGenInputEvent, TextGenActionEvent, TextGenResponseEvent
...
class EvaluationCallback(BaseAsyncCallback):
    ...
    async def on_agent_generation_end(
        ...
        if step:
            ...
            debug('AFDSFDSFSDFDSFSDFSDFFSDFDSF')
