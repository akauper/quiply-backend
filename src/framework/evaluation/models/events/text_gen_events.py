...
from src.framework.runnables.generators.text import TextGenerator
from src.framework.runnables.generators.text.models import TextGenerationRequest, TextResponse
